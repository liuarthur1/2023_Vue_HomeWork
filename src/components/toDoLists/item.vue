...
<template>
  <li class="flex items-center justify-between py-6 border-b">
    <div class="flex items-center gap-3">
      <input  @change="toggleCompleted" type="checkbox" id="todo_id_1" class="checkbox" />
      <label for="todo_id_1" class="text-xl cursor-pointer" :class="{ 'line-through': todo.completed }">
